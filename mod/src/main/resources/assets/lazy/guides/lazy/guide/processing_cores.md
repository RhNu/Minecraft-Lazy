...
When placed in the [Simulation Chamber](simulation_chamber.md), Processing Cores increase its speed and output. The chamber accepts up to 64 cores, and does not consume them.
