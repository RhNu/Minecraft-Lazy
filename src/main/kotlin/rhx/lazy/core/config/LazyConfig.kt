...
internal class LazyConfigValue<T : Any> internal constructor(
    ...
    internal fun bind(isLoaded: () -> Boolean) {
        this.isLoaded = isLoaded
    }
}

/** Small Kotlin-facing subset of [ModConfigSpec.Builder] used by Lazy. */
internal class LazyConfigBuilder internal constructor(
    ...
    internal fun bind(spec: ModConfigSpec) {
...
internal class LazyConfigDefinition<T> private constructor(
    val settings: T,
    internal val spec: ModConfigSpec,
) {
    fun registerServer(
