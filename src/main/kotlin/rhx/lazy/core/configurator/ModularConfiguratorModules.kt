...
internal interface ModularConfiguratorModule {
...
internal open class ModularConfiguratorModuleRegistry {
    ...
    @Synchronized
    internal fun snapshot(): List<ModularConfiguratorModule> = modules.values.toList()
}

internal object ModularConfiguratorModules : ModularConfiguratorModuleRegistry()
