...
internal object DataGeneration {
    ...
    private class Recipes(
        ...
        override fun buildRecipes(output: RecipeOutput) {
            ...
            ShapedRecipeBuilder
                ...
                .save(output)
            ShapedRecipeBuilder
                .shaped(RecipeCategory.MISC, ProcessingCoreRegistries.t1.get())
                .pattern("CRC")
                .pattern("RBR")
                .pattern("CRC")
                .define('C', Tags.Items.INGOTS_COPPER)
                ...
                .save(output)
            ShapedRecipeBuilder
                .shaped(RecipeCategory.MISC, ProcessingCoreRegistries.t2.get())
                .pattern("IGI")
                .pattern("GTG")
                .pattern("IGI")
                .define('I', Tags.Items.INGOTS_IRON)
                .define('G', Tags.Items.INGOTS_GOLD)
                .define('T', ProcessingCoreRegistries.t1.get())
                .unlockedBy("has_t1_core", has(ProcessingCoreRegistries.t1.get()))
                .save(output)
            ShapedRecipeBuilder
                .shaped(RecipeCategory.MISC, ProcessingCoreRegistries.t3.get())
                .pattern("DDD")
                .pattern("DTD")
                .pattern("DDD")
                .define('D', Tags.Items.GEMS_DIAMOND)
                .define('T', ProcessingCoreRegistries.t2.get())
                .unlockedBy("has_t2_core", has(ProcessingCoreRegistries.t2.get()))
                .save(output)
            ShapedRecipeBuilder
                .shaped(RecipeCategory.MISC, ProcessingCoreRegistries.t4.get())
                .pattern("NNN")
                .pattern("NTN")
                .pattern("NNN")
                .define('N', Tags.Items.INGOTS_NETHERITE)
                .define('T', ProcessingCoreRegistries.t3.get())
                .unlockedBy("has_t3_core", has(ProcessingCoreRegistries.t3.get()))
                .save(output)
            ShapedRecipeBuilder
    ...
    private class EnglishLanguage(
        ...
        override fun addTranslations() {
            ...
            addItem({ ProcessingCoreRegistries.t1.get() }, "T1 Processing Core")
            addItem({ ProcessingCoreRegistries.t2.get() }, "T2 Processing Core")
            addItem({ ProcessingCoreRegistries.t3.get() }, "T3 Processing Core")
            addItem({ ProcessingCoreRegistries.t4.get() }, "T4 Processing Core")
    ...
    private class ChineseLanguage(
        ...
        override fun addTranslations() {
            ...
            addItem({ ProcessingCoreRegistries.t1.get() }, "T1 处理核心")
            addItem({ ProcessingCoreRegistries.t2.get() }, "T2 处理核心")
            addItem({ ProcessingCoreRegistries.t3.get() }, "T3 处理核心")
            addItem({ ProcessingCoreRegistries.t4.get() }, "T4 处理核心")
