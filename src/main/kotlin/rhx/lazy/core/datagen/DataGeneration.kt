...
internal object DataGeneration {
    ...
    private class EnglishLanguage(
        ...
        override fun addTranslations() {
            ...
            add("tooltip.lazy.energy_battery.insert", "Sneak-use a block to insert the battery into an accepting side")
            add("tooltip.lazy.energy_battery.charge", "Attack an energy-capable block to transfer energy")
    ...
    private class ChineseLanguage(
        ...
        override fun addTranslations() {
            ...
            add("tooltip.lazy.energy_battery.insert", "潜行使用方块以从可接收的一面放入电池")
            add("tooltip.lazy.energy_battery.charge", "敲击支持能量的方块以传输能量")
