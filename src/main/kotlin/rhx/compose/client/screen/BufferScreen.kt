package rhx.compose.client.screen
...
import rhx.compose.network.ClearBufferPayload
...
internal class BufferScreen(
    ...
    override fun startScreen() {
        ...
        clearButton =
            ButtonComponent(
                ...
                CLEAR_BUTTON_WIDTH,
                20,
                Component.translatable("gui.compose.buffer.clear"),
            ) { _, _, _, _, mouseButton ->
                if (mouseButton != 0) {
                    false
                } else {
        ...
        override fun renderTooltips(
            ...
            lines +=
                Component.translatable(
                    "gui.compose.buffer.item_amount",
                    item.count,
                )
    ...
    private class BufferFluidComponent(
        ...
        override fun render(
            ...
            val name =
                if (fluid.isEmpty) {
                    Component.translatable("gui.compose.buffer.empty").string
                } else {
            ...
            graphics.drawCenteredString(
                font,
                Component.translatable(
                    "gui.compose.buffer.fluid_amount",
                    fluid.amount,
                ),
                width / 2,
                29,
