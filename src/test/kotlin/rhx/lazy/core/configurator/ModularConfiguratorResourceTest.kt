...
class ModularConfiguratorResourceTest {
    ...
    fun `GuideME guide binds both language pages to the item hotkey`() {
        ...
        val english =
            Files.readString(
                projectRoot.resolve("src/main/resources/assets/lazy/guides/lazy/guide/modular_configurator.md"),
            )
        val chinese =
            Files.readString(
                projectRoot.resolve("src/main/resources/assets/lazy/guides/lazy/guide/_zh_cn/modular_configurator.md"),
            )
