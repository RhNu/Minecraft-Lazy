...
@LazyInternalApi
public object LazyCreativeTabRegistry : RegistryModule {
            ...
            Supplier {
                CreativeModeTab
                    ...
                    .displayItems { _, output ->
                        ...
                        output.accept(ReplicatorRegistries.item.get())
                        ...
                        ProcessingCoreRegistries.allItems().forEach { output.accept(it.get()) }
                    }.build()
            },
        )
