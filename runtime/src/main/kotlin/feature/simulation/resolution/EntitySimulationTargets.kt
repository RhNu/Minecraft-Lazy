...
@LazyInternalApi
public object EntitySimulationTargets {
    private val plainItemTargets =
        mapOf(
            Items.DRAGON_EGG to EntityType.ENDER_DRAGON,
        )

    internal fun resolve(stack: ItemStack): EntitySimulationTargetResolution {
    ...
    internal fun isAllowed(type: EntityType<*>): Boolean = !type.`is`(SimulationTags.entityTargetBlacklist)

    internal fun representative(
