...
@LazyInternalApi
public object SimulationRegistries : RegistryModule {
    ...
    internal val block = blocks.register("simulation_chamber", Supplier(::SimulationChamberBlock))
    val item =
    ...
    internal val itemInjectionRecipeType =
