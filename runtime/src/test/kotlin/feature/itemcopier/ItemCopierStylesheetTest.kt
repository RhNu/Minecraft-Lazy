...
class ItemCopierStylesheetTest {
    @Test
    fun `item copier stylesheet selectors and declarations are valid`() {
        val text =
            requireNotNull(javaClass.getResourceAsStream("/assets/lazy/lss/item_copier.lss"))
                .bufferedReader()
                .use { it.readText() }
