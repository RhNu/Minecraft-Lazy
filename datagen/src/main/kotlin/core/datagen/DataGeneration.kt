...
internal object DataGeneration {
    ...
    private class Recipes(
        ...
        override fun buildRecipes(output: RecipeOutput) {
            ...
            ShapedRecipeBuilder
                ...
                .save(output)
            ShapedRecipeBuilder
                .shaped(RecipeCategory.MISC, DataGenExports.itemCopierItem())
                .pattern(" C ")
                .pattern("BMB")
    ...
    private class BlockStates(
        ...
        override fun registerStatesAndModels() {
            ...
            machineBlock(DataGenExports.itemCopierBlock())
    ...
    private class LootTables(
        ...
        private class BlockLoot(
            ...
            override fun generate() {
                ...
                add(DataGenExports.itemCopierBlock(), noDrop())
            ...
            override fun getKnownBlocks(): MutableIterable<Block> =
                mutableListOf(
                    ...
                    DataGenExports.itemCopierBlock(),
    ...
    private class EnglishLanguage(
        ...
        override fun addTranslations() {
            ...
            addBlock({ DataGenExports.itemCopierBlock() }, "Item Copier")
            ...
            addItem({ DataGenExports.processingCoreT1() }, "T1 Processing Core")
            addItem({ DataGenExports.processingCoreT2() }, "T2 Processing Core")
            addItem({ DataGenExports.processingCoreT3() }, "T3 Processing Core")
            addItem({ DataGenExports.processingCoreT4() }, "T4 Processing Core")
    ...
    private class ChineseLanguage(
        ...
        override fun addTranslations() {
            ...
            addBlock({ DataGenExports.itemCopierBlock() }, "物品复制器")
            ...
            addItem({ DataGenExports.processingCoreT1() }, "T1 处理核心")
            addItem({ DataGenExports.processingCoreT2() }, "T2 处理核心")
            addItem({ DataGenExports.processingCoreT3() }, "T3 处理核心")
            addItem({ DataGenExports.processingCoreT4() }, "T4 处理核心")
