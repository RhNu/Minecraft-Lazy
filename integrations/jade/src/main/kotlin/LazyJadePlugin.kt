...
import rhx.lazy.feature.replicator.ReplicatorBlock
...
import rhx.lazy.integration.jade.client.ReplicatorJadeComponentProvider
...
class LazyJadePlugin : IWailaPlugin {
    override fun register(registration: IWailaCommonRegistration) {
        ...
        registration.registerBlockDataProvider(ReplicatorJadeDataProvider, ReplicatorBlockEntity::class.java)
    ...
    override fun registerClient(registration: IWailaClientRegistration) {
        ...
        registration.registerBlockComponent(ReplicatorJadeComponentProvider, ReplicatorBlock::class.java)
